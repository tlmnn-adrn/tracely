...
<html lang="de">
  <head>
    ...
    <script src="static/js/headerscroll.js"></script>
    ...
    <footer id="footer" class="FilltextMidSektionBACKCALM">
      <div id="footer-mid" class="FilltextMidSektionContent">
        <div class="FooterContentBox" id="footer-mid-left">
          <div class="FooterItem"><a class="aText" href="">Impressum</a></div>
          <div class="FooterItem"><a class="aText" href="">Kontakt</a></div>
        </div>
