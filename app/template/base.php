...
<html lang="de">
  <head>
    ...
    <link rel='stylesheet' href='<?= $this->link("")?>static/style/style.css'>
        ...
        <div class="HeaderMidBox" id="header-mid-side">
          <div id="header-mid-side-content">
            ...
            <?php if (!AuthModel::isLoggedIn()): ?>
              ...
              <a href="<?= $this->link("")?>login"><div id="headerlink-login" class="HeaderMidSideContentBox aButton">Login</div></a>
              <a href="<?= $this->link("")?>registrierung"><div id="headerlink-registrierung" class="HeaderMidSideContentBox aButtonInvert aButton">Registrieren</div></a>
            ...
            <a href=""><div id="headerlink-logout" class="HeaderMidSideContentBox aButton">Logout <img src="static/media/backend/logout.svg"></div></a>
            <?php endif?>
